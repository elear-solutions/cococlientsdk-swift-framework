...
typedef enum {
  ...
  COCO_STD_ATTR_STATIONARY_POSITION_BEACON_LOC,
  COCO_STD_ATTR_STATIONARY_POSITION_DEVICE_LOC,
...
} coco_std_attr_stationary_position_beacon_loc_t;
...
typedef struct {
  ...
  double yCoordinate;
  uint32_t environmentalFactor;  
} coco_std_attr_stationary_position_device_loc_t;
