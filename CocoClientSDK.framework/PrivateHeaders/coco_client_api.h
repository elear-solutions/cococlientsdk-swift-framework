 ...
 * @param    networkId: ID of the coconet to which the scene belongs to
 *           sceneId  : ID of the scene to be executed
 ...
 *                      cocoClientErrno will be set on error.
 ***********************************************/
int32_t coco_client_execute_scene(char *networkId, uint16_t sceneId, void *context);
